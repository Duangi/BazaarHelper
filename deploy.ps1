# --- 配置区 ---
$NEW_VERSION = "1.6.3"  # <--- 版本号

# 【新增】这里写你想对用户说的话（支持换行 \n）
# 比如：这次更新了巨龟数据！\n如果不小心是花钱买的，快去退款买杯奶茶！
$ANNOUNCEMENT_TEXT = "🎉 v$NEW_VERSION 1.新增了历史战绩功能（如果截图不准可以在历史战绩页面手动截图或者 更改截图延时） 2.支持上传到网站. 3.注意：新版本只更新了文字内容。图片以及野怪信息暂时没更新。正在寻找快速的更新方案... 4.可能使用了加速mod的不兼容战绩功能"
