# --- 配置区 ---
$NEW_VERSION = "1.4.0"  # <--- 版本号

# 【新增】这里写你想对用户说的话（支持换行 \n）
# 比如：这次更新了巨龟数据！\n如果不小心是花钱买的，快去退款买杯奶茶！
$ANNOUNCEMENT_TEXT = "🎉 v$NEW_VERSION 更新来了：1.修复百科的输入法问题，并优化百科搜索的交互。 2. 为了解决白条的问题，删除了手动移动右键详情页面的功能，现在需要手动设置参数调整。 3. 新增右键查询事件的功能。 4. 新增yolo自动识别+手动识别。5.事件的识别准确性暂时比较低"
